...
object JdbcUtil {
 ...
 PARTITION BY toYYYYMM(date) ORDER BY (id, name, email) SETTINGS index_granularity = 8192"""
  ...
  private val DATA = Array(
    Row.of(new Object() {
      1
    }, "Addy", "amcgeagh0@berkeley.edu", new Object() {
      0.4
    }, "2018-09-28"),
    Row.of(new Object() {
      2
    }, "Kristos", "kmcshee1@salon.com", new Object() {
      0.9
    }, "2018-10-04"),
    Row.of(new Object() {
      3
    }, "Teodorico", "tsked2@google.fr", new Object() {
      0.8
    }, "2018-12-09"),
    Row.of(new Object() {
      4
    }, "Emilie", "elory3@vistaprint.com", new Object() {
      0.5
    }, "2018-08-26"),
    Row.of(new Object() {
      5
    }, "Lyndy", "lmeiklejohn4@foxnews.com", new Object() {
      0.0
    }, "2018-04-11"),
    Row.of(new Object() {
      6
    }, "Delores", "dcuxson5@netlog.com", new Object() {
      0.1
    }, "2018-08-10"),
    Row.of(new Object() {
      7
    }, "Terri", "tmintoff6@godaddy.com", new Object() {
      0.1
    }, "2018-10-01"),
    Row.of(new Object() {
      8
    }, "Dietrich", "djantot7@skyrock.com", new Object() {
      0.5
    }, "2018-09-23"),
    Row.of(new Object() {
      9
    }, "Ilka", "ifaulconbridge8@chron.com", new Object() {
      0.0
    }, "2019-01-25"),
    Row.of(new Object() {
      10
    }, "Baldwin", "btocknell9@biblegateway.com", new Object() {
      0.4
    }, "2018-03-16"),
    Row.of(new Object() {
      11
    }, "Dwight", "dkelloga@indiegogo.com", new Object() {
      0.7
    }, "2018-07-28"),
    Row.of(new Object() {
      12
    }, "Haydon", "hoagb@google.de", new Object() {
      0.6
    }, "2018-03-22"),
    Row.of(new Object() {
      13
    }, "Hartley", "hdolemanc@nbcnews.com", new Object() {
      0.9
    }, "2018-11-11"),
    Row.of(new Object() {
      14
    }, "Tab", "tshirdd@photobucket.com", new Object() {
      0.1
    }, "2019-02-21"),
    Row.of(new Object() {
      15
    }, "Carlynn", "cchrismase@multiply.com", new Object() {
      0.1
    }, "2018-08-04"),
    Row.of(new Object() {
      16
    }, "Ossie", "olacazef@time.com", new Object() {
      0.1
    }, "2018-03-16"),
    Row.of(new Object() {
      17
    }, "Caria", "cbowlerg@wordpress.org", new Object() {
      0.1
    }, "2018-11-23"),
    Row.of(new Object() {
      18
    }, "Charity", "cclaringboldh@digg.com", new Object() {
      0.4
    }, "2018-09-21"),
    Row.of(new Object() {
      19
    }, "Lesly", "ljillingsi@marriott.com", new Object() {
      0.2
    }, "2018-11-13"),
    Row.of(new Object() {
      20
    }, "Derick", "dblebyj@t.co", new Object() {
      0.2
    }, "2018-05-13"))
}
